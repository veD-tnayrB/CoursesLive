...
export async function editComment(episodeId, commentId, editedComment) {
	try {
		const { data } = await axios.patch(
			`${ENVIRONMENT}episode/${episodeId}/comment/${commentId}/edit`,
			editedComment
		);
		return data;
	} catch ({ response: { data: errors } }) {
...
export async function removeComment(episodeId, commentId) {
	try {
