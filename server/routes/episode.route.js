...
// Create
episodeRouter.post('/:courseId/episodes/create', isUserAdminOrTeacher, imageUploader.single('miniature'), videoUploader.single('video'), isBodyAEpisode, episodes.create);
